...
for ua in range(5000):
      ...
      b=random.choice(['15','16','17','18','19','20'])
...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak -a 300 \"well come,to the monster  Bangladesh Random Cloning Start Please Wait\"")
logo=(f"""
...
\033[1;32m==================================================
          Author     : HASAN IS KING
          Telegram   : @UDCBD71          
          Facebook   : UPDATE.DARK.CYBER.BD71
          Github     : Fuckbd71 
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[PAID•3]\x1b[0m
\033[1;31m================================================== 
os.system("espeak \x1b[0;97m\x1b[1;43m         🍂  HASAN KING  IS A BRAND 🥰          \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%HASAN\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
